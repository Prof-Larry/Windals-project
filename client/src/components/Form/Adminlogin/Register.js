...
export default function Register() {
  ...
  const register = () => {
    axios
      .post(`${serverUrl}/adminregister`, user)
      .then((res) => {
  ...
  return (
    ...
    >
      <div className="register-form">
        ...
        <div className="group-1">
          <label style={{ alignSelf: "flex-start" }} htmlFor="phone">
            Phone
          </label>
          <input
            id="phone"
        ...
        <div className="group-1">
          <label style={{ alignSelf: "flex-start" }} htmlFor="confirmpassword">
            Confirmpassword
          </label>
          <input
            id="confirmpassword"
        ...
        <button onClick={register} className="btn btn-success mt-3 rounded">
          Register
        </button>
      </div>
    </div>
